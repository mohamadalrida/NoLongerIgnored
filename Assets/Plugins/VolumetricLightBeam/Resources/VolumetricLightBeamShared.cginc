...
{
#define PACKING_PRECISION 64
    half4 color;

    color.a = packedFloat % PACKING_PRECISION;
    packedFloat = floor(packedFloat / PACKING_PRECISION);

    color.b = packedFloat % PACKING_PRECISION;
    packedFloat = floor(packedFloat / PACKING_PRECISION);

    color.g = packedFloat % PACKING_PRECISION;
    packedFloat = floor(packedFloat / PACKING_PRECISION);

    color.r = packedFloat;

    return color / (PACKING_PRECISION - 1);
}
